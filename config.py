...
# ─── Paths ────────────────────────────────────────────────────────────────────
# INPUT_FOLDER  = r'C:\Users\PZWind-DhyeyK\Desktop\post-pro\V7_Simulations\IEC_2A_\OUTPUT\all'   # folder containing .outb / .out files
# OUTPUT_FOLDER = r'C:\Users\PZWind-DhyeyK\Desktop\post-pro\V7_Simulations\IEC_2A_\OUTPUT\exeTest'            # root output folder


# Dynamically fetch paths injected by runner.py (Step 0)
INPUT_FOLDER = os.environ.get("OPENFAST_INPUT_FOLDER")
OUTPUT_FOLDER = os.environ.get("OPENFAST_OUTPUT_FOLDER")
LC_POSTPROCESS_PATH = os.environ.get("OPENFAST_LC_PATH")
SENSOR_LIST_PATH = os.environ.get("OPENFAST_SENSOR_LIST_PATH")
...
# LC_POSTPROCESS_PATH = r'C:\Users\PZWind-DhyeyK\Desktop\post-pro\V7_github_akash\V7\LC_PostProcess.txt'
# SENSOR_LIST_PATH = r'C:\Users\PZWind-DhyeyK\Desktop\post-pro\V7_github_akash\V7\sensorList.txt'
